      ...
      },
      {
        ...
        parameters: {
          ...
          properties: {
            ...
            timeframe: {
              type: 'string',
              description: 'The timeframe of the user query for signal or analyze default is 1h, e.g., 5m, 15m, 1h, 4h, 1d etc.',
            },
          },
...
private async sendQm2Buttons(chatId: number, symbol: string) {
  ...
  await this.bot.sendMessage(
    ...
    `یکی از گزینه‌ها را برای ${symbol} انتخاب کنید:`,
    {
      reply_markup: {
        inline_keyboard: [
          [A('سیگنال ۵ دقیقه') ],[A('سیگنال ۱۵ دقیقه') ],[ A('سیگنال ۱ ساعته') ],
