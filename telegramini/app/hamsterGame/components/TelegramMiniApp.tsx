  ...
  return (
    <TonConnectUIProvider manifestUrl={manifestUrl}>
      <div className={styles.container}>
        ...
        {gameStarted ? (
          <div>
            <h1 className={`${styles.title} ${inter.className}`}>Lucky 1.5 | Unlucky 0.05</h1>
            <div>
              {loading ? (
            ...
            <button className={`${styles.button} ${inter.className}`} onClick={handleFlip}>Flip</button>
            <br />
            <button className={`${styles.button} ${inter.className}`} onClick={handleResetGame}>Retry</button>
          </div>
        ) : (
          <div>
            <h1 className={`${styles.title} ${inter.className}`}>Each Telegram user receives 1000 of our tokens</h1>
            <div className={`${styles.qrCode} ${styles.containerItems}`}>
              <QRCode value="https://4bridges.ch/en/porsche-cayman-token/" size={256} />
            </div>
            <button className={`${styles.button} ${inter.className}`} onClick={handleStartGame}>Start Game</button>
          </div>
        )}
      </div>
