...
export default function GameHeader({ address, balance, chainId, network }: HeaderProps) {
  ...
  const displayAddress = isHovered || isClicked ? address : shortenAddress(address ?? '');
      ...
      <div className="px-6 md:px-12 sm:px-2 ">
        <div className="flex justify-between items-center">
          <div className="flex-1 px-2 mx-2">
            ...
            onClick={handleClick}
            className="cursor-pointer">🟢 {displayAddress  ?? "Wallet Address"}</span>
          </div>
